<?php
	...
	$dataArray['email'] = EMAIL_PAGSEGURO;
	$dataArray['token'] = TOKEN_PAGSEGURO;

	$dataArray['paymentMode'] = "default";
	$dataArray['paymentMethod'] = $data['paymentMethod'];
	$dataArray['receiverEmail'] = $data['receiverEmail'];
